...
(function() {
  ...
  if (!noAudio) {
    ...
    var codecs = {
      ...
      m4a: !!(audioTest.canPlayType('audio/x-m4a;') || audioTest.canPlayType('audio/mp4;') || audioTest.canPlayType('audio/aac;')).replace(/^no$/, ''),
    ...
    play: function(sprite, callback) {
      ...
      self._inactiveNode(function(node) {
        ...
        if (self._webAudio) {
          ...
          if (node.readyState === 4 || !node.readyState && (navigator.isCocoonJS || window.ejecta)) {
            node.readyState = 4;
            node.id = soundId;
